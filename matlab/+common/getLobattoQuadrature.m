function [quad_nodes, quad_weights] = getLobattoQuadrature(dof)
    % depending on dof parameter calculates quadrature points and weights, currently only yields 
    % uniformly distributed nodal basis and saves it into the workspace
    arguments (Input)
