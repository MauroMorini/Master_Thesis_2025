            ...
            for el_idx_2=1:2
                ...
                for loc_node_idx_1=1:dof
                    for loc_node_idx_2=1:dof
                        ...
                        triplet_list_entries(triplet_list_iterator) =   sigma/h_loc_min*phi{loc_node_idx_1}(F_ref(xk,xn_loc_1,h_loc_1))*phi{loc_node_idx_2}(F_ref(xk,xn_loc_2,h_loc_2))...
                                                                        *outward_normal(el_idx_1)*outward_normal(el_idx_2)...
