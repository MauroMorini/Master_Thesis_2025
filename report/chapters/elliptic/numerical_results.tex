...
\begin{stepscope}
    ...
    \begin{step}[Exact Solution]
        ...
        \begin{equation*}
            u_1(x) = x^r, \qquad u_2(x) = e^{-x}\sin(x),
        \end{equation*}
    ...
    \begin{step}[Mesh]
        We choose one of the two following initial meshes: A uniform mesh
        \begin{equation*}
            \mathcal{M}_1 = \{0, \frac{1}{4}, \frac{1}{2}, \frac{3}{4}, 1\}
        \end{equation*}
        with initial meshsize $h = \frac{1}{4}$, and a non uniform mesh
        \begin{equation*}
            \mathcal{M}_2 = \{ \}
        \end{equation*}
    \end{step}
...
Let $h \in \{2^{-l}| \, l\in \{2,\ldots,9\} \}$ denote the global (uniform) meshsize and $\mathcal{T}_h$ denote
the respective partition of $\Omega$. \\
As an example for $h = 2$ we have 
\begin{equation*}
\mathcal{T}_h = \{(0, 0.25), (0.25, 0.5),(0.5, 0.75),(0.75, 1)\}.    
\end{equation*}
To begin we consider the constant coefficient $c\equiv 1$. In this case choosing $\sigma = 10(r+1)^2$ guarantees positive definiteness of the 
system matrix.
To 
