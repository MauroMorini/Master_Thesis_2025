...
\begin{stepscope}
    ...
    \begin{step}[Mesh]
        We choose an initial mesh, i.e.\ an initial partition of the domain $\Omega$. For our purpose we only present the uniform mesh
        \begin{equation*}
...
To round off this chapter we now present a small intuitive example.